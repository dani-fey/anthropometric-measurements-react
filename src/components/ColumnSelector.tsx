...
export const ColumnSelector = ({ label, defaultValue, onChange }: {label: string, defaultValue?: string, onChange: (column: string) => void}) => {
  ...
  return <>
    <FormControl>
      ...
      <Select defaultValue={defaultValue} onChange={(_, v) => handleChange(v as string)}>
        {optionComponents}
      </Select>
